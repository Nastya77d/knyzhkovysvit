...
function importData(event) {
    ...
    reader.onload = function(e) {
        try {
            ...
            if (confirm("Це оновить ВСІ твої списки. Продовжити?")) {
                // Записуємо кожен ключ окремо, щоб нічого не загубити
                ...
                if (data.tbrList) localStorage.setItem('tbrList', JSON.stringify(data.tbrList));
